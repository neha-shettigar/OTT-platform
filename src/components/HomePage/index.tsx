...
const HomePage = () => {
  ...
  // fetch search data when click search button in the search bar
  React.useEffect(() => {
    axios
      .get(
        `https://api.themoviedb.org/3/movie/popular?api_key=13622fc50c5257d370284ea008163f90&language=en-US&page=1`,
      )
      .then((result) => {
